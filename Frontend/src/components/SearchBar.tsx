export const SearchBar = () => {
    return <div>
                ...
                <input id="default-search" className="w-full bg-slate-950 text-black border-none outline-none"
                placeholder="Search" required />
        <button className="bg-grey-950 text-gray-400 font-bold py-2 px-4 rounded inline-flex items-center">
